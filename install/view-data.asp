...
if ( web ){
	web.value = window.location.origin && window.location.origin.length > 0 ? window.location.origin : window.location.hostname;
};
if ( tweb ){
	tweb.innerHTML = window.location.origin && window.location.origin.length > 0 ? window.location.origin : window.location.hostname;
};
</script>